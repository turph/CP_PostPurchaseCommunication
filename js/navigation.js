$(document).ready(function(){
	...
	$("#nav_uc1a").click(function() {
		$("#uc1a").show("slow");
		$("#uc1b, #uc2a, #uc2b, #uc2c, #uc2d, #uc3a, #uc3b, #uc4a").hide("slow");
		$("#nav_uc1a").toggleClass("active");
		$("#nav_uc1b, #nav_uc2a, #nav_uc2b, #nav_uc2c, #nav_uc2d, #nav_uc3a, #nav_uc3b, #nav_uc4a").removeClass();
		// Order Confirmation
	...
	$("#nav_uc1b").click(function() {
		$("#uc1b").show("slow");
		$("#uc1a, #uc2a, #uc2b, #uc2c, #uc2d, #uc3a, #uc3b, #uc4a").hide("slow");
		$("#nav_uc1b").toggleClass("active");
		$("#nav_uc1a, #nav_uc2a, #nav_uc2b, #nav_uc2c, #nav_uc2d, #nav_uc3a, #nav_uc3b, #nav_uc4a").removeClass();
		// Order Confirmation
	...
	$("#nav_uc2a").click(function() {
		$("#uc2a").show("slow");
		$("#uc1a, #uc1b, #uc2b, #uc2c, #uc2d, #uc3a, #uc3b, #uc4a").hide("slow");
		$("#nav_uc2a").toggleClass("active");
		$("#nav_uc1a, #nav_uc1b, #nav_uc2b, #nav_uc2c, #nav_uc2d, #nav_uc3a, #nav_uc3b, #nav_uc4a").removeClass();
		// Order Confirmation
	...
	$("#nav_uc2b").click(function() {
		$("#uc2b").show("slow");
		$("#uc1a, #uc1b, #uc2a, #uc2c, #uc2d, #uc3a, #uc3b, #uc4a").hide("slow");
		$("#nav_uc2b").toggleClass("active");
		$("#nav_uc1a, #nav_uc1b, #nav_uc2a, #nav_uc2c, #nav_uc2d, #nav_uc3a, #nav_uc3b, #nav_uc4a").removeClass();
		// Order Confirmation
	...
	$("#nav_uc2c").click(function() {
		$("#uc2c").show("slow");
		$("#uc1a, #uc1b, #uc2a, #uc2b, #uc2d, #uc3a, #uc3b, #uc4a").hide("slow");
		$("#nav_uc2c").toggleClass("active");
		$("#nav_uc1a, #nav_uc1b, #nav_uc2a, #nav_uc2b, #nav_uc2d, #nav_uc3a, #nav_uc3b, #nav_uc4a").removeClass();
		// Order Confirmation
	...
	$("#nav_uc2d").click(function() {
		$("#uc2d").show("slow");
		$("#uc1a, #uc1b, #uc2a, #uc2b, #uc2c, #uc3a, #uc3b, #uc4a").hide("slow");
		$("#nav_uc2d").toggleClass("active");
		$("#nav_uc1a, #nav_uc1b, #nav_uc2a, #nav_uc2b, #nav_uc2c, #nav_uc3a, #nav_uc3b, #nav_uc4a").removeClass();
		// Order Confirmation
	...
	$("#nav_uc3a").click(function() {
		$("#uc3a").show("slow");
		$("#uc1a, #uc1b, #uc2a, #uc2b, #uc2c, #uc2d, #uc3b, #uc4a").hide("slow");
		$("#nav_uc3a").toggleClass("active");
		$("#nav_uc1a, #nav_uc1b, #nav_uc2a, #nav_uc2b, #nav_uc2c, #nav_uc2d, #nav_uc3b, #nav_uc4a").removeClass();
		// Order Confirmation
	...
	$("#nav_uc3b").click(function() {
		$("#uc3b").show("slow");
		$("#uc1a, #uc1b, #uc2a, #uc2b, #uc2c, #uc2d, #uc3a, #uc4a").hide("slow");
		$("#nav_uc3b").toggleClass("active");
		$("#nav_uc1a, #nav_uc1b, #nav_uc2a, #nav_uc2b, #nav_uc2c, #nav_uc2d, #nav_uc3a, #nav_uc4a").removeClass();
		// Order Confirmation
		$("#uc3b #confirmationEmail #header").load('includes/header/header.html #confirmation');
		$("#uc3b #confirmationEmail #intro").load('includes/intro/intro.html #uc3b_oc');
		$("#uc3b #confirmationEmail #details").load('includes/orderDetails/orderDetails.html #uc3b_oc');
		$("#uc3b #confirmationEmail #support").load('includes/support/support.html');
		$("#uc3b #confirmationEmail #extras").load('includes/extras/extras.html #uc3b_oc');
	...
	$("#nav_uc4a").click(function() {
		$("#uc4a").show("slow");
		$("#uc1a, #uc1b, #uc2a, #uc2b, #uc2c, #uc2d, #uc3a, #uc3b").hide("slow");
		$("#nav_uc4a").toggleClass("active");
		$("#nav_uc1a, #nav_uc1b, #nav_uc2a, #nav_uc2b, #nav_uc2c, #nav_uc2d, #nav_uc3a, #nav_uc3b").removeClass();
		// Order Confirmation
